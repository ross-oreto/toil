create table address (id bigint GENERATED BY DEFAULT AS IDENTITY (START WITH 1), line varchar(255), primary key (id))
...
create sequence db_sequence start with 1 increment by 1
